...
public class AttemdanceController {
	...
	@ResponseBody
	@GetMapping("/attList")
	public ArrayList<Attemdance> attList(@RequestParam(value = "currentPage", defaultValue = "1") int currentPage,
			Model model) {
	...
	public ArrayList<EmpAttemdance> selectAttDate(Model model, String inputDate1, String inputDate2,
...
//	@ResponseBody
//	@GetMapping("/comList")
//	public HashMap<String, Object> comOnList(String daysc,
...
//	}
	...
	public ArrayList<CommuteOn> comSearchList(@RequestParam(value = "currentPage", defaultValue = "1") int currentPage,
			String condition, String keyword, String inputDate1, String inputDate2, String daysc) {
